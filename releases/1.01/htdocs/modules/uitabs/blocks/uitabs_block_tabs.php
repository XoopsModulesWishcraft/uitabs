...
function b_uitabs_blocks_tabs_show( $options )
{
	...
	$GLOBALS['xoTheme']->addScript('', array('type'=>'text/javascript'), '$("ul.blocks_'.$_ModConfig['ul_class'].'").tabs("div.blocks_'.$_ModConfig['div_class'].' > div", {
	current: \''.$_ModConfig['default_class'].'\',
	effect: \''.$_ModConfig['effect'].'\',
	event: \''.$_ModConfig['event'].'\',
	fadeInSpeed: '.$_ModConfig['fadeInSpeed'].',
	fadeOutSpeed: '.$_ModConfig['fadeOutSpeed'].',
	history: '.$_ModConfig['history'].',
	initialIndex: '.$initialIndex.',
	rotate: '.$_ModConfig['rotate'].',							
});');
