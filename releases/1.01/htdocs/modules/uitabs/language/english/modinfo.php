<?php
	...
	define('_MI_TABS_STYLE','/modules/'._MI_TABS_DIRNAME.'/langauge/'.$GLOBALS['xoopsConfig']['language'].'/uitabs.css');
	...
	define('_MI_TABS_HISTORY_TRUE','True');
	define('_MI_TABS_HISTORY_FALSE','False');
	...
	define('_MI_TABS_ROTATE_TRUE','True');
	define('_MI_TABS_ROTATE_FALSE','False');
