<?php
	...
	function uitabs_items_get_form($object, $as_array=false) {
		...
		$ele['image'] = new XoopsFormLabel(($as_array==false?_FRM_TABS_FORM_ITEM_IMAGE:''), $id.'[image]', $object->getVar('image'));
		$ele['image']->setDescription(($as_array==false?_FRM_TABS_FORM_ITEM_IMAGE_DESC:''));
		$ele['path'] = new XoopsFormLabel(($as_array==false?_FRM_TABS_FORM_ITEM_PATH:''), $id.'[path]', $object->getVar('path'));
		$ele['path']->setDescription(($as_array==false?_FRM_TABS_FORM_ITEM_PATH_DESC:''));
		$ele['extension'] = new XoopsFormLabel(($as_array==false?_FRM_TABS_FORM_ITEM_EXTENSION:''), $id.'[extension]', $object->getVar('extension'));
		$ele['extension']->setDescription(($as_array==false?_FRM_TABS_FORM_ITEM_EXTENSION_DESC:''));
		$ele['width'] = new XoopsFormLabel(($as_array==false?_FRM_TABS_FORM_ITEM_WIDTH:''), $id.'[width]', $object->getVar('width'));
		$ele['width']->setDescription(($as_array==false?_FRM_TABS_FORM_ITEM_WIDTH_DESC:''));
		$ele['height'] = new XoopsFormLabel(($as_array==false?_FRM_TABS_FORM_ITEM_HEIGHT:''), $id.'[height]', $object->getVar('height'));
		$ele['height']->setDescription(($as_array==false?_FRM_TABS_FORM_ITEM_HEIGHT_DESC:''));
		if ($GLOBALS['xoopsModuleConfig']['matrixstream']) {
			$ele['pid'] = new UitabsFormSelectPackageID(($as_array==false?_FRM_TABS_FORM_ITEM_PID:''), $id.'[pid]', $object->getVar('pid'));
			$ele['pid']->setDescription(($as_array==false?_FRM_TABS_FORM_ITEM_PID_DESC:''));
		}
		if ($GLOBALS['xoopsModuleConfig']['flowplayer']) {
			$ele['fid'] = new UitabsFormSelectPlayer(($as_array==false?_FRM_TABS_FORM_ITEM_FID:''), $id.'[fid]', $object->getVar('fid'));
